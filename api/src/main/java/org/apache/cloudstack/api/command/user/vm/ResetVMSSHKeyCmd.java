...
public class ResetVMSSHKeyCmd extends BaseAsyncCmd implements UserCmd {
    ...
    @Parameter(name = ApiConstants.SSH_KEYPAIRS, type = CommandType.LIST, required = false, description = "name of the multiple ssh key pairs used to login to the virtual machine")
